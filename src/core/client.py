...
class OpenAIClient:
    ...
    async def create_response(
        ...
        """Send response to OpenAI Responses API with cancellation support."""
    ...
    async def create_response_stream(
        ...
        """Send streaming response to OpenAI Responses API with cancellation support."""
        ...
        try:
            ...
            streaming_response = await self.client.responses.create(**request)
