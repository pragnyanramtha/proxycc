...
def main():
    if len(sys.argv) > 1 and sys.argv[1] == "--help":
        ...
        print(f"  MAX_TOKENS_LIMIT - Token limit, or 0 for uncapped passthrough (default: 4096)")
    ...
    max_tokens_display = "uncapped (backend-enforced)" if config.max_tokens_uncapped else str(config.max_tokens_limit)
    print(f"   Max Tokens Limit: {max_tokens_display}")
